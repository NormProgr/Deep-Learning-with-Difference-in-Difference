...
from difference_in_difference_with_deep_learning.config import BLD, PAPER_DIR

documents = ["difference_in_difference_with_deep_learning", "difference_in_difference_with_deep_learning_pres"]
